...
<head>
    ...
    <link rel="stylesheet" href="home_page/assets/css/style.css">
</head>
<body>
    ...
    <div id="cont" class="container">
        ...
        <div id="signUp" class="sign-up">
            <h2>Sign Up</h2>
            <form action="home_page/signup_connect.php" method="POST" enctype="multipart/form-data">
                
                <div id="firstSign">
                    <?php
                        echo (isset($_GET['errorSign']) ? '<p style="color:#ffe485; margin-top:10px;margin-bottom:10px;">' . $_GET['errorSign'] . '<p>' : '');
                    ?>
                    <div class="nuser-box">
        ...
        <div id="logIn" class="loginbox">
            <h2>Login</h2>
            <form method="POST" action="home_page/login_connect.php">
                <div id="firstSign">
                    <?php
                        echo (isset($_GET['error']) ? '<p style="color:#ffe485; margin-top:10px;margin-bottom:10px;">' . $_GET['error'] . '</p>' : '');
                    ?>
                    <div class="nuser-box">
    ...
    <!-- --------------- End button --------------- -->
    <script src="home_page/assets/js/index.js"></script>
    <?php
